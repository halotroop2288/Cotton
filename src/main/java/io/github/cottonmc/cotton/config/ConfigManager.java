...
public class ConfigManager {
    ...
    public static <T> T loadConfig(Class<T> clazz, String configName){
        try {
            File file = new File(Objects.requireNonNull(ConfigManager.class.getClassLoader()
                    .getResource(configName)).getFile()); // FIXME: This placeholder probably doesn't work.
